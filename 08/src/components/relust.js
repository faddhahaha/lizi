...
class Relust extends Component {
    ...
    componentDidMount() {
       const a =new URLSearchParams(this.props.location.search.substr(1)) 
       const player1 = a.get('player1'); 
       const player2 = a.get('player2'); 
        ...
        const player1Url = `https://api.github.com/users/${player1}`;
        const player2Url = `https://api.github.com/users/${player2}`;
